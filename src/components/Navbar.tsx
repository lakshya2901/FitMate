...
export default function Navbar() {
  ...
  return (
    <nav className="p-4 md:p-6 shadow-md shadow-gray-300 bg-gray-900 text-white border-b border-gray-900">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="flex items-center space-x-4">
          {session ? (
            <>
              <span className="text-\white font-medium">Welcome, {user.username || user.email}</span>
              <Button 
                onClick={() => signOut()} 
